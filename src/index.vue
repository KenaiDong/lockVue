<template>
    <div class="login-wrap">
        <div class="ms-title" style="font-size: 30px">我的收藏夹<span style="font-size: 10px; margin-left: 0px;">
            <u></u></span>
        </div>
        <div class="tab">
            <el-table :data="data" border ref="multipleTable" >
                ...
                <el-table-column label="点击次数" prop="count" width="100px" ></el-table-column>
