<template>
    <div class="login-wrap">
        <div class="ms-title" style="font-size: 30px">我的收藏 - 用户登录<span style="font-size: 10px; margin-left: 0px;">
            <u></u></span>
        </div>
        ...
        methods: {
            submit(){
                if(this.ruleForm.username===""){
                    ...
                    if(this.ruleForm.username == "test"){
                        console.log("test");
                        ...
                        this.$http.post(main.url+"/user/login",
                        {'loginName': this.ruleForm.username, 'password': this.ruleForm.password},
                        {
                            headers: {'Content-Type':'application/x-www-form-urlencoded'},
                            emulateJSON: true
                        }).then(
                        success => {
                            if(success.data.obj.id != null){
